...
* Based on script: ./examples/wireless/wifi-rate-adaptation-distance.cc
...
NS_LOG_COMPONENT_DEFINE("DQN-rate-control");
...
main(int argc, char* argv[])
{
    ...
    bool shortGuardInterval = false;//Guard interval = 0.8us
    uint32_t chWidth = 20;
    int ap1_x = 0;
    int ap1_y = 0;
    int sta1_x = 5;
...
//    cmd.AddValue("staManager", "Rate adaptation manager of the STA", staManager);
    ...
    apManager = "ns3::"+apManager + "WifiManager";
