...
def get_agent(socketUuid, use_rl):
...
ns3Settings = {
    ...
    'simSeed': my_sim_seed}
env = gym.make("ns3ai_gym_env/Ns3-v0", targetName="ns3ai_DQN_rate_gym",
...
try:
    ...
    DeepQAgent = get_agent(obs[0], args.use_rl)
    ...
    while True:
        ...
        action = DeepQAgent.get_action(obs, reward, done, info)
